...
local Library = {
    ...
    FontColor = Color3.fromRGB(252, 252, 252);
    MainColor = Color3.fromRGB(252, 252, 252);
    BackgroundColor = Color3.fromRGB(252, 252, 252);
    AccentColor = Color3.fromRGB(194, 155, 0);
    OutlineColor = Color3.fromRGB(194, 155, 0);
